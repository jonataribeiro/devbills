...
import { Wallet, TrendingUp, List, CreditCard } from "lucide";
	...
	const features: ReadonlyArray<Feature> = [
		{
			...
			description:
				"Monitore suas despesas e receitas em um sí lugar, com uma interface intuitiva e fácil de usar.",
		},

		{
			...
			title: "Relatórios",
			description:
				"Visualize gratificamente seus gastos e entenda para onde seu dinheirpo está indo.",
		},
...

		{
			...
			description:
				"Adicione quantas transações quiser e mantenha um histórico completp de suas finanças.",
		},
	];
			...
			<div className="container-app">
				...
				<section className="py-12 md:py-20">
					<div className="bg-gray-900 p-8 md:p-12 rounded-xl text-center border border-gray-700">
						...
						<p className="text-white text-opacty-90 max-w-2xl mx-auto mb-8">
							Comece a usar o Devbills hoje mesmo e tenha controle total sobre
